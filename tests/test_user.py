...
class TestUser(unittest.TestCase):
    def setUp(self):
        """set up tests for user model and routes"""
        self.app = create_app()
        ...
        self._user_with_lower_case_password = {
            "firstname": "kabaki",
            "email": "kabaki.kiarie@gmail.com",
            "password": "banuit*123",
            "companyId": 1,
        ...
        self._user_with_upper_case_password = {
            "firstname": "kabaki",
            "email": "kabaki.kiarie@gmail.com",
            "password": "BANUIT*123",
            "companyId": 1,
        ...
        self._user_with_missing_fields = {
            "firstname": "kabaki",
            "email": "",
            "password": "Banuit*123",
            "companyId": 1,
        ...
        self._user_with_short_password = {
            "firstname": "kabaki",
            "email": "kabaki.kiarie@gmail.com",
            "password": "B*12",
            "companyId": 1,
        ...
        self._user_login_with_correct_information = {
            "email": "kabaki.kiarie@gmail.com",
            "password": "Banuit*123"
        }
        self._user_login_with_incorrect_password = {
            "email": "kabaki.kiarie@gmail.com",
            "password": "Banuit*123s"
        }
        self._unregistered_user = {
